    ...
    private void loadData() {
        ...
        userRepository.getUser(currentUser.getUid(), new UserRepository.LoadUserCallback() {
            ...
            public void onSuccess(User user) {
                ...
                String buildingCode = user.buildingCode != null ? user.buildingCode.trim() : "";
                String aptNumber = user.aptNumber != null ? user.aptNumber.trim() : "";
                String uid = currentUser.getUid();

                loadMachineData(buildingCode, aptNumber, uid);
            }
        ...
        FirebaseDatabase.getInstance()
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot machine : snapshot.getChildren()) {
                            ...
                            for (DataSnapshot entry : machine.child("history").getChildren()) {
                                ...
                                if (entryUid != null && entryUid.equals(uid)) {
                                    belongsToUser = true;
                                } else if (entryApt != null
                                        && userApartment != null
                                        && !userApartment.isEmpty()
                                        && entryApt.equals(userApartment)) {
                                    belongsToUser = true;
                                }
                                ...
                                historyList.add(new HistoryItem(machineName, epoch, safeDuration, cost));
                        ...
                        tvMonthlyTotal.setText(String.format(Locale.US, "$%.2f CAD", monthlyTotal));
