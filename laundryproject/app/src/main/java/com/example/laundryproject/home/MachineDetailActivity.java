...
public class MachineDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartMachine = findViewById(R.id.btnStartMachine);
            ...
            writeCurrentSessionForMachine(new SessionWriteCallback() {
                ...
                public void onSuccess() {
                    Toast.makeText(
                            ...
                            "Machine linked to your session.",
                            Toast.LENGTH_SHORT
                    ).show();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        try {
                            ...
                            Double lastCost = snapshot.child("lastSessionCostCAD").getValue(Double.class);
    ...
    private void writeCurrentSessionForMachine(SessionWriteCallback callback) {
        ...
        userRepository.getUser(currentUser.getUid(), new UserRepository.LoadUserCallback() {
            ...
            public void onSuccess(User user) {
                ...
                sessionData.put("price", machinePrice > 0 ? machinePrice : 2.50);
    ...
    private void updateUI(String state, String timestamp, Double lastCost) {
        ...
        double doneCost = lastCost != null ? lastCost : displayPrice;
        ...
        if ("RUNNING".equalsIgnoreCase(state)) {
            ...
            tvCost.setText(String.format(Locale.US, "$%.2f CAD", doneCost));
            tvStartedAt.setText("Ready to use");
            stopTimer();

            btnStartMachine.setEnabled(true);
            btnStartMachine.setText("Start Machine");
